...
const lenders = [
    { name: 'Kashyap Rajodiya', type: 'mistnest', quantity: 20, date: new Date(), status: 'pending', dateDue: ''},
    ...
    { name: 'Kashyap Rajodiya', type: 'trap', quantity: 20, date: new Date(), status: 'pending', dateDue: ''},
